...
settings = ["gade","tiere","enere","slut"]
set_address = False
index = 0
street_index = 0
tens = 0
ones = 4
top_text = "Bilen står ud for:"
address = streets[street_index]+" "+str(tens+ones)
lead_text = "Tryk på B for at ændre"
display_address()
...
def button(pin):
    ...
    if pin == button_b and not set_address:
        ...
        set_address = True
        top_text = "Vælg gade"
        lead_text = "A: op, C: ned, B: næste punkt"
        display_address()
        return
